...
<body class="bg-white flex items-center justify-center min-h-screen">
    ...
    class="absolute right-40 w-150 -z-10 -rotate-15 ">
   
      <!-- Left (Form) -->
      <div class="bg-orange-400 text-white max-w-xl h-[500px] p-10 rounded-2xl items-center flex-1">
        ...
        <form action="#"   class="space-y-4">
          ...
          <div>
            <label class="block font-semibold mb-1" for="Confirm Password">Confirm Password</label>
            <input 
            id="Confirm Password"
            type="password" 
            placeholder="Confirm Password"
            required
            class="w-full px-4 py-2 rounded-md text-black bg-white focus:outline-no"
            >
